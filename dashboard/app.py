...
APP_TITLE = "Dashboard phân tích chất lượng không khí, khí tượng và bệnh hô hấp"
...
DASHBOARD_MAPPING = pd.DataFrame([
    {"Mã": "D01", "Biểu đồ": CHART_TITLES["D01"], "Liên hệ báo cáo Word/output": "figure_02_annual_respiratory_trend; figure_04_respiratory_by_region"},
    {"Mã": "D02", "Biểu đồ": CHART_TITLES["D02"], "Liên hệ báo cáo Word/output": "figure_06_pm25_vs_respiratory"},
    {"Mã": "D03", "Biểu đồ": CHART_TITLES["D03"], "Liên hệ báo cáo Word/output": "figure_04_respiratory_by_region"},
    {"Mã": "D04", "Biểu đồ": CHART_TITLES["D04"], "Liên hệ báo cáo Word/output": "supp_03_country_summary"},
    {"Mã": "D05", "Biểu đồ": CHART_TITLES["D05"], "Liên hệ báo cáo Word/output": "figure_03_respiratory_by_income"},
    {"Mã": "D06", "Biểu đồ": CHART_TITLES["D06"], "Liên hệ báo cáo Word/output": "figure_10_actual_vs_predicted"},
    {"Mã": "D07", "Biểu đồ": CHART_TITLES["D07"], "Liên hệ báo cáo Word/output": "figure_12_global_actual_vs_predicted_over_time"},
    {"Mã": "D08", "Biểu đồ": CHART_TITLES["D08"], "Liên hệ báo cáo Word/output": "supp_10_test_error_by_region"},
])
...
filtered_pred = pred_df[
    ...
    (pred_df["income_level"].isin(selected_income)) &
...
with left:
    annual_trend = filtered_df.groupby(["year", "region"], as_index=False)["respiratory_disease_rate"].mean()
...
with right:
    country_summary_filtered = (
        filtered_df
        .groupby(["country_code", "country_name", "region", "income_level"], as_index=False)
    ...
    fig_d04_country = px.bar(
        ...
        y="mean_resp",
        color="region",
        hover_data={"country_code": True, "income_level": True, "mean_pm25": ":.2f", "mean_aqi": ":.2f", "mean_resp": ":.2f"},
...
if filtered_pred.empty:
    ...
    with st.expander("Bảng sai số dự báo theo vùng"):
        st.dataframe(error_by_region, use_container_width=True)

with st.expander("Bảng mapping dashboard"):
